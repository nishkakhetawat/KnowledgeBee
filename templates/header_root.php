                    ...
                    <?php if (isLoggedIn()): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationsDropdown">
                                ...
                                <li><a class="dropdown-item" href="pages/notifications.php">View all</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                ...
                                <li><a class="dropdown-item" href="pages/upload.php">
                                    <i class="bi bi-upload"></i> Upload Content
                                </a></li>
                                <li><a class="dropdown-item" href="pages/my-content.php">
